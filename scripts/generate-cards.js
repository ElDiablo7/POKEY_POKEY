...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 112" width="80" height="112">
  ...
  <rect x="6" y="6" width="68" height="100" rx="8" fill="none" stroke="#e8b923" stroke-width="1" opacity="0.4"/>
  <text x="12" y="24" font-family="Georgia, serif" font-size="16" font-weight="bold" fill="${color}">${rankLabel}</text>
  <text x="12" y="42" font-family="Georgia, serif" font-size="20" fill="${color}">${suitChar}</text>
  <text x="40" y="66" font-family="Georgia, serif" font-size="34" fill="${color}" text-anchor="middle" font-weight="bold">${suitChar}</text>
  <text x="68" y="94" font-family="Georgia, serif" font-size="16" font-weight="bold" fill="${color}" text-anchor="end">${rankLabel}</text>
  <text x="68" y="108" font-family="Georgia, serif" font-size="20" fill="${color}" text-anchor="end">${suitChar}</text>
</svg>`;
}
